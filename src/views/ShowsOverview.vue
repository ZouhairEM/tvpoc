<template>
  <div class="container-fluid" v-if="xtotalCount > 0">
    <WelcomeScreen />
    <HeaderComponent
      :filters="xfilters"
      :filteredShows="xfilteredShows"
    ...
    <div class="d-flex justify-content-center p-2 mt-4">
      <input type="text" v-model="xsearch" placeholder="Type to find a show" class="p-2 px-3" />
      <button
        class="black-btn mt-0 mb-2 mx-3"
        @click="() => (xsearch = '')"
        :disabled="!xsearch.length"
      >
        Clear
      </button>
    </div>
    <div class="row mt-4 position-relative">
      <div v-if="xtypedShow.length === 0" class="empty p-2 mx-auto">
        <h3 class="d-flex justify-content-center">
          No shows were found with a name of '{{ xsearch }}'
        </h3>
        <svg
          version="1.0"
        ...
        >
          <g
            class="disappear-icon"
            transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
            stroke="none"
          >
            <path
              d="M1870 5013 c-27 -10 -59 -45 -65 -72 -4 -17 15 -104 50 -237 74 -277
82 -300 112 -324 61 -48 153 -2 153 75 0 37 -110 462 -132 511 -19 41 -74 63
-118 47z"
            />
            <path
              d="M3011 4853 c-20 -21 -33 -51 -48 -118 -45 -193 -47 -210 -33 -244 26
-63 111 -78 158 -28 30 32 96 314 83 350 -27 70 -109 90 -160 40z"
            />
            <path
              d="M1205 4548 c-34 -18 -55 -51 -55 -88 0 -29 27 -75 145 -252 80 -120
156 -225 170 -234 35 -23 93 -13 123 21 46 53 36 79 -120 313 -78 118 -153
223 -167 233 -26 21 -66 24 -96 7z"
            />
            <path
              d="M4050 4537 c-26 -13 -66 -61 -286 -340 -112 -143 -124 -162 -124
-198 0 -77 86 -126 147 -84 20 14 330 400 379 472 38 57 28 115 -26 146 -33
20 -56 21 -90 4z"
            />
            <path
              d="M337 4173 c-65 -22 -140 -91 -174 -160 -22 -45 -27 -71 -28 -127 0
...
28 59 85 78 142 48z"
            />
            <path
              d="M2418 4110 c-101 -21 -218 -69 -303 -125 -87 -56 -212 -188 -265
...
24 -388 -1z"
            />
            <path
              d="M4645 4067 c-198 -52 -323 -244 -286 -438 33 -166 144 -277 310 -310
...
-51 17 -103 74 -119 128 -21 76 10 160 74 198 64 38 126 40 195 8z"
            />
            <path
              d="M1261 3426 c-87 -48 -50 -186 49 -186 51 0 100 49 100 100 0 73 -85
122 -149 86z"
            />
            <path
              d="M2567 3209 c-109 -26 -218 -114 -272 -221 -58 -117 -40 -193 51 -205
...
387 -63 5 -65 6 -100 54 -96 130 -283 196 -447 157z"
            />
            <path
              d="M4725 2905 c-5 -2 -50 -9 -98 -15 -98 -14 -141 -38 -150 -87 -8 -40
16 -89 53 -108 28 -15 40 -15 143 0 135 19 164 29 182 66 27 52 11 110 -36
135 -26 13 -70 17 -94 9z"
            />
            <path
              d="M255 2657 c-45 -45 -47 -84 -6 -129 28 -32 33 -33 128 -39 158 -11
280 -10 307 2 14 7 32 27 41 46 15 31 15 40 3 71 -23 61 -49 69 -256 77 l-182
7 -35 -35z"
            />
            <path
              d="M1635 2216 c-53 -53 -56 -171 -8 -278 48 -107 164 -186 283 -192 57
...
31 -85 75 -77 145 7 56 -3 87 -39 115 -32 26 -92 23 -121 -6z"
            />
            <path
              d="M215 1744 c-168 -61 -192 -74 -205 -110 -17 -44 -11 -74 19 -105 22
-22 39 -29 67 -29 55 0 334 105 362 136 51 58 3 165 -75 164 -10 -1 -85 -25
-168 -56z"
            />
            <path
              d="M4425 1576 c-36 -36 -42 -73 -19 -114 16 -29 47 -50 189 -124 150
-78 175 -88 210 -84 53 6 85 43 85 97 0 57 -23 75 -209 168 -178 90 -215 98
-256 57z"
            />
            <path
              d="M740 1093 c-23 -9 -148 -113 -170 -141 -24 -30 -26 -84 -4 -117 9
-14 33 -30 54 -36 46 -14 58 -8 156 73 101 83 118 131 67 188 -28 30 -74 45
-103 33z"
            />
            <path
              d="M1636 859 c-35 -28 -276 -508 -276 -550 0 -18 11 -41 29 -61 24 -27
36 -33 69 -33 26 0 48 7 62 20 37 33 270 509 270 551 0 78 -93 121 -154 73z"
            />
            <path
              d="M4057 870 c-150 -38 -274 -176 -293 -327 -14 -111 38 -257 117 -328
...
-97 24 -100 69 -115 203 -33 286 52 51 113 65 188 43z"
            />
            <path
              d="M2769 621 c-23 -23 -29 -38 -29 -71 0 -55 50 -380 61 -402 15 -29 68
...
-42 38 -92 37 -131 -2z"
      ...
      <div
        class="show-item col-sm-12 col-md-6 col-lg-4"
        v-for="(show, i) in xtypedShow"
        :key="i"
        @click="() => pushWithRoute(show.id)"
      >
...
export default {
  ...
  setup() {
    const xsearch = ref('');
    const xshows = ref([]);
    const xfilteredShows = ref([]);
    const xtotalCount = ref(0);
    ...
    onMounted(() => {
      fetch('https://api.tvmaze.com/shows')
        ...
        .then((response) => {
          const unproxiedResponse = toRaw(response);
          xshows.value = unproxiedResponse;
          xtotalCount.value = xshows.value.length;
          xfilteredShows.value = xshows.value;
        });
      availableFilters();
    });

    const xtypedShow = computed(() => {
      return xfilteredShows.value.filter((show) => {
        return toRaw(show).name.toLowerCase().indexOf(xsearch.value.toLowerCase()) !== -1;
      });
    });

    const pushWithRoute = (show) => {
      router.push({ name: 'shows', params: { id: show } });
    };

    const availableFilters = () => {
      console.log(xshows.value);
      uniqueFilters.value.push('dd', 'aa');
      console.log(toRaw(uniqueFilters.value));
    };

    // xshows.value.filter((show) => {
    //   return show.genres.forEach((genre) => {
    //     if (!xfilters.value.includes(genre)) {
    //       xfilters.value.sort().push(genre);
    //     }
    //   });
    // });
  ...
  methods: {
    ...
    //     .then((response) => {
    //       this.shows = response
    //       this.totalCount = this.shows.length
  ...
  // computed: {
  //   typedShow() {
  //     return this.filteredShows.filter(
  //       (show) => show.name.toLowerCase().indexOf(this.search.toLowerCase()) !== -1
  //     )
  //   }
  // }
  // created() {
